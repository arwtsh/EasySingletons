...
public static class SingletonManager
{
    ...
    private static List<System.Type> FindSingletonTypes()
    {
        ...
        List<System.Type> singletonTypes = Assembly.GetAssembly(typeof(Singleton<>)).GetTypes()
            .Where(t => t.BaseType != null && t.BaseType.IsGenericType && t.BaseType.GetGenericTypeDefinition() == typeof(Singleton<>))
            .ToList();
